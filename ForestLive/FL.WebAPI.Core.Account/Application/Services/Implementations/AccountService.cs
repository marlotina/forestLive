...
using FL.WebAPI.Core.Account.Application.Exceptions;
...
namespace FL.WebAPI.Core.Account.Application.Services.Implementations
{
    public class AccountService : IAccountService
    {
        ...
        public async Task<AuthResponse> Authenticate(string username, string password)
        {
            ...
            if (result == PasswordVerificationResult.Success)
            {
                ...
                var userImage = await this.iUserCosmosRepository.GetUserImage(user.UserName, user.UserName);
                ...
                return new AuthResponse
                {
                    ...
                    Photo = await this.iUserCosmosRepository.GetUserImage(user.UserName, user.UserName)
                };
            }
