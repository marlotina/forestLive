...
namespace FL.Functions.UserPost
{
    public class Startup : FunctionsStartup
    {
        public override void Configure(IFunctionsHostBuilder builder)
        {
            ...
            var postCosmosDbService = new CommentPostCosmosDbService(client, databaseName);

            builder.Services.AddSingleton<ICommentPostCosmosDbService>(postCosmosDbService);
        }
    }
}